...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        positiveQuotes = loadJSON(NSBundle.mainBundle().pathForResource("positiveQuotes", ofType: "json")!) as [String]!
        
        negativeQuotes = loadJSON(NSBundle.mainBundle().pathForResource("negativeQuotes", ofType: "json")!) as [String]!
